...
/**
 * This is meant to demonstrate how to extend the LinkTool to avoid the manual
 * use of "magic" or common query parameters. So instead of doing
 * $link.param('layout', 'Table.vm') in your template, you would just do
 * $link.layout('Table').
 *
 * @author Nathan Bubna
